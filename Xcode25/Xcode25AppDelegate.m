...
#import "Xcode25AppDelegate.h"

@implementation Xcode25AppDelegate
...
- (void)drawDockProgress:(NSTimer*)timer
{
  ...
  [icon lockFocus];
  [progressBackground drawInRect:bounds fromRect:NSZeroRect operation:NSCompositeSourceOver fraction:1.0];
